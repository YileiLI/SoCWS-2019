...
<body>
    ...
    <form id="form1" runat="server">
        <h1 aria-selected="undefined" style="font-family: 'MS Gothic'; text-align:center;font-size: 80px; font-weight: bold; color: #7A14EB">Velib
        </h1>
        <asp:Button ID="Button34" runat="server" Text="GoToMap" Height="51px" Width="125px" OnClick="Button34_Click" />
