<%@ Page Async="true"  Title="GetRoute" Language="C#" AutoEventWireup="true" CodeBehind="GetRoute.aspx.cs" Inherits="WebClientGoogle.GetRoute" %>
...
<body>
    <form id="form1" runat="server">
        <div id="city">
            ...
            <asp:TextBox ID="CityTextBox" runat="server" OnTextChanged="CityTextBox_TextChanged"></asp:TextBox>
        ...
        <div id="inputFROM" style="width: 330px; display: inline-block">
            ...
            <asp:TextBox ID="start" runat="server" Width="305px" OnTextChanged="start_TextChanged"></asp:TextBox>
        ...
        <div id="inputFROM" style="width: 330px; display: inline-block">
            ...
            <asp:TextBox ID="end" runat="server" Width="305px" OnTextChanged="end_TextChanged"></asp:TextBox>
        ...
        <asp:Button ID="Button1" runat="server" Text="Submit" OnClientClick="calculateAndDisplayRoute(); return false;" />
