...
using WebClientGoogle.VelibServer;
...
namespace WebClientGoogle
{
    public partial class GetRoute : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            //ClientScript.RegisterStartupScript(this.GetType(), "aa", "<script type=text/javascript> calculateAndDisplayRoute() </script>");//click1('aaaa')是前台jquery函数
        }
